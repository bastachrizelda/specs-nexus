...
# Connection pool settings optimized for Supabase's connection pooler
# Using NullPool to avoid connection pooling conflicts with Supabase's pooler
# Set USE_NULL_POOL=1 in .env if you're hitting max clients errors
use_null_pool = os.getenv("USE_NULL_POOL", "1") == "1"
...
if use_null_pool:
    ...
    engine_kwargs = {
        "pool_size": 15,           # Minimal pool size for Supabase free tier
        "max_overflow": 2,        # Allow up to 3 total connections
